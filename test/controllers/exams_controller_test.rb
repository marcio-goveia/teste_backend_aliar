...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { name: @exam.name, status: @exam.status, type: @exam.type } }, as: :json
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { name: @exam.name, status: @exam.status, type: @exam.type } }, as: :json
    assert_response 200
  end
